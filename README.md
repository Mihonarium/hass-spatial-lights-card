...
| Select area (marquee) | Click and drag on empty canvas | Drag on empty canvas (a straight-down drag scrolls instead — start at a slight angle, or hold ~0.3 s first) |
