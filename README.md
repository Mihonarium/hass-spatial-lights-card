...
- [x] Fix the bug where too many preset/live lights on the desktop get displayed under the color wheel in a way that enlarges the color wheel area and makes the sliders smaller
- [x] Fix the bug that on clearing the picture and picking a new one, the previous picture settings don't apply to the new picture
