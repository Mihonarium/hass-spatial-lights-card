...
3. Click **Create scene from…**, name the scene, and the card will save it (with a matching scene ID) so you can edit it later from Home Assistant Settings → Scenes.
