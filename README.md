...
3. Click **Create scene from…**, give the scene a friendly name, and confirm the generated scene ID to snapshot their current state. The name and ID are stored so you can edit the scene later in Home Assistant.
