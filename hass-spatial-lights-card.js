      ...
      .slider {
        ...
        background-image:
          linear-gradient(to right,
            var(--slider-fill) 0%,
            var(--slider-fill) calc(var(--slider-thumb-size) / 2),
            transparent calc(var(--slider-thumb-size) / 2),
            transparent 100%),
          var(--slider-track);
        background-size: calc(100% - var(--slider-thumb-size)) 100%, calc(100% - var(--slider-thumb-size)) 100%;
        background-repeat: no-repeat, no-repeat;
        background-position: left calc(var(--slider-thumb-size) / 2) center, left calc(var(--slider-thumb-size) / 2) center;
